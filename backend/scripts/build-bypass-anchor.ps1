# Build with Bypass Anchor Script
# This script completely bypasses Anchor's toolchain detection and builds directly with system Rust

Write-Host "Starting Build with Bypass Anchor..." -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "Completely bypassing Anchor toolchain detection..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Building smart contract directly with system Rust..." -ForegroundColor Yellow
...
# CRITICAL: Try to build with explicit toolchain and force system paths
Write-Host "Attempting to build with explicit Rust 1.79.0..." -ForegroundColor Yellow

# Set PATH to prioritize system Rust
