...
async function quickDelete() {
  ...
  try {
    ...
    console.log('🗑️ Deleting stuck matches...');
    // Delete all stuck matches in one query with a simple WHERE clause
    ...
    `);
    console.log(`✅ Deleted ${result.rowCount} matches`);
  } catch (error) {
