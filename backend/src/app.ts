...
app.use('/api/admin/auth', adminAuthRoutes.default || adminAuthRoutes); // Public auth endpoints
app.use('/api/admin', adminRoutes.default || adminRoutes); // Protected admin endpoints
