...
export const config = {
  ...
  BACKEND_SIGNER_PUBKEY: process.env.NEXT_PUBLIC_BACKEND_SIGNER_PUBKEY || '2Q9WZbjgssyuNA1t5WLHL4SWdCiNAQCTM5FbWtGQtvjt',
...
console.log('🔍 Environment Config:', {
  ...
  BACKEND_SIGNER_PUBKEY: config.BACKEND_SIGNER_PUBKEY,
