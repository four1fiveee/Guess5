    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary px-4 sm:px-6 relative">
      ...
      <div className="flex flex-col items-center max-w-4xl w-full">
        ...
        <div className="how-it-works bg-gradient-to-br from-purple-500/20 via-pink-500/10 to-purple-500/20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 mt-6 shadow-xl border border-purple-500/30 w-full">
          <h2 className="text-xl sm:text-2xl font-bold text-accent mb-4">💰 How It Works</h2>
          
          <div className="space-y-4 text-white/90 text-sm">
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <h3 className="text-base font-bold text-accent mb-2">Earning Structure</h3>
              <p className="text-white/80 mb-3">
                When someone uses your referral link and plays, you earn from <strong className="text-white">25% of the match's net profit</strong> (Platform Fee - Bonus - Network Costs). Earnings flow up 3 levels with geometric decay:
              </p>
              <div className="grid grid-cols-3 gap-2 mb-3">
                <div className="bg-accent/20 border border-accent/40 rounded-lg p-2 text-center">
                  <div className="text-lg font-black text-accent">L1</div>
                ...
                <div className="bg-purple-500/20 border border-purple-500/40 rounded-lg p-2 text-center">
                  <div className="text-lg font-black text-purple-400">L2</div>
                  <div className="text-xs text-white/80">25%</div>
                </div>
                <div className="bg-pink-500/20 border border-pink-500/40 rounded-lg p-2 text-center">
                  <div className="text-lg font-black text-pink-400">L3</div>
                  <div className="text-xs text-white/80">6.25%</div>
                </div>
              </div>
            </div>

            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <h3 className="text-base font-bold text-accent mb-2">Requirements & Payouts</h3>
              <ul className="space-y-1.5 text-white/80 text-xs">
                <li>• Play at least <strong className="text-white">one match</strong> to become eligible</li>
                <li>• Minimum payout: <strong className="text-accent">$20 USD</strong> (accumulates until threshold)</li>
                <li>• Payouts: <strong className="text-white">Every Sunday at 1:00 PM EST</strong> via batched on-chain transactions</li>
                <li>• USD amounts converted to SOL at payout time using current market rates</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="terms bg-gradient-to-br from-white/10 via-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 mt-6 shadow-xl border border-white/20 w-full">
          <h2 className="text-xl sm:text-2xl font-bold text-accent mb-4">Quick FAQ</h2>
          <div className="space-y-3 text-white/80 text-sm">
            <div>
              <strong className="text-white">Can I refer myself?</strong>
              <p className="mt-1 text-white/70">No, self-referrals are automatically prevented.</p>
            </div>
            <div>
              <strong className="text-white">What if I haven't played yet?</strong>
              <p className="mt-1 text-white/70">You can refer players, but payouts require at least one match played.</p>
            </div>
            <div>
              <strong className="text-white">How are USD amounts converted to SOL?</strong>
              <p className="mt-1 text-white/70">Conversion happens at payout time using current market rates, so SOL amounts may vary slightly.</p>
            </div>
          </div>
        </div>
      </div>
